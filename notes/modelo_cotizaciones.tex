...
\label{eq:logit}
\end{equation}
donde $f^{sr}_{k,g}(\cdot)$ es una función escalonada o spline de la duración
(constante para $d \ge \bar D$) y $h^{sr}_{g}(\cdot)$ un polinomio o spline en
edad. La interacción completa tipo$\times$duración en $f^{sr}_{k,g}$ es el
objeto central: capturar cuánta memoria de duración sobrevive dentro de tipo.
