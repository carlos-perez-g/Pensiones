...
(edad $=$ cohorte $+$ tiempo; Deaton--Paxson) y el crecimiento agregado se
confundiría con retornos a la edad. La atribución a período y no a cohorte
es el supuesto estándar en la literatura de ciclo de vida y es discutible;
