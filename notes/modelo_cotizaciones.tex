...
proporciones estimadas son desiguales ($\hat\pi_{k|g}$, orden
frágil/intermitente/estable: hombres 0,36/0,21/0,43; mujeres
0,41/0,16/0,43). La clasificación dura por terciles de densidad —usada como
inicialización y robustez— coincide con el tipo modal EM en los polos
($\sim$75\%) pero no en el centro: el EM agrupa por \emph{dinámica} de los
hazards y no por densidad bruta, y reasigna casi la mitad del tercil medio
de densidad al tipo estable. Por lo mismo, el tipo frágil no equivale a
``casi no cotiza'': sus densidades medias son 0,37 (hombres) y 0,31
(mujeres). Solo la mitad de los individuos exhibe posterior modal superior
a 0,9, lo que desaconseja la clasificación dura como especificación
principal.
...
(6.242 persona--año y selección severa); con tipos EM reúne 28.257
persona--año y sus parámetros son regulares ($\rho = 0{,}67$), eliminando la
