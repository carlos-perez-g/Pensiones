...
asignación por terciles de la densidad individual \emph{dentro de cada sexo}
(edades 20--65, mínimo 60 meses de historia potencial). Robustez: (i) clasificación con la densidad de
...
conjuntamente \citep{heckman1984}, dejando la clasificación dura como caso
particular.
...
$\times$ 2 estados) se estimaron sobre celdas agregadas
duración$\times$edad (estadístico suficiente del MLE con regresores
categóricos aditivos). La Figura~\ref{fig:hazfit} muestra el ajuste para la
...
fijo individual) arrojan $\rho \in [0{,}5,\ 0{,}7]$ y
$\sigma^2_\eta \in [0{,}05,\ 0{,}09]$ para los grupos grandes; el grupo
mujer--bajo es inestimable con precisión (6.242 persona--año y selección
severa) y su proceso salarial se tratará por agrupación con el tipo medio,
decisión pendiente de sensibilidad.
...
—el hecho estilizado central— emerge de la dinámica estimada; el modelo
polariza levemente en exceso (sobrepredice ambas colas en $\sim$2 puntos) y
alarga levemente la cola de duración de lagunas, sesgos conservadores para
nuestra aplicación (implican, si acaso, más riesgo de laguna del que hay).
...
\toprule
 & Datos & Modelo \\
\midrule
Densidad media                          & 0,538 & 0,532 \\
Densidad individual: p10                & 0,040 & 0,046 \\
\quad p50                               & 0,563 & 0,545 \\
\quad p90                               & 0,953 & 0,955 \\
Share densidad $<$ 0,10                 & 0,155 & 0,173 \\
Share densidad $>$ 0,90                 & 0,165 & 0,188 \\
Duración de lagunas: mediana (meses)    & 3     & 3     \\
\quad media                             & 11,3  & 12,6  \\
\quad p90                               & 27    & 30    \\
Episodios de laguna por individuo       & 7,7   & 7,7   \\
\bottomrule
\end{tabular}
\end{table}
